            ...
            <Container fluid>
                ...
                <Row>
                    <Col style={{ paddingTop: "19px" }}>
                        <Table id="tablestyle" size='md' responsive striped bordered hover variant="dark">
                            <thead style={{ color: "pink", fontWeight: "bold" }}>
                                <tr style={{ textAlign: "center" }}>
                                    <th style={{ textAlign: "center" }}><Image id="thumbnailPic" src={galpics.tpic} thumbnail fluid/><br />Type of Set</th>
                                    <th style={{ textAlign: "center" }}><Image id="thumbnailPic" src={galpics.shortNails} thumbnail fluid /><br />Short Nails</th>
                                    <th style={{ textAlign: "center" }}><Image id="thumbnailPic" src={galpics.medNails} thumbnail fluid /><br />Med Nails </th>
                                    <th style={{ textAlign: "center" }}><Image id="thumbnailPic" src={galpics.longNails} thumbnail fluid /><br />Longs Nails</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
