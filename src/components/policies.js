...
export const policies = (
  <p>
    ...
    <br />
    <br />
    <span className="policy">Lost or stolen Gift Cards</span> : Treat your Gift
    Card like cash. Lost or stolen cards will not be replaced or refunded.
    <br />
    <br />
    <span className="policy">Gift Cards cannot be canceled</span> : You cannot
    cancel your Gift Card.
    <br />
    <br />
    ...
    <br />
    <br />
    <span className="policy">Late Arrivals</span> : Tardiness Scheduled
    appointments have a 15-minute grace period to allow for unpredicted traffic
    or parking difficulties. If you anticipate that you will be later than 15
    minutes, please call ahead to see if we have the availability to complete
    your service in full. One late client can throw off our entire schedule and
    cause other clients to be late for their commitments. Therefore, if you
    arrive more than 15 minutes late, we reserve the right to refuse partial or
    complete services. <br />
    <br />
    <span className="policy">No Call No Show</span> : If you do not arrive to
    your scheduled appointment time within 15-minutes you will be considered a
    no-show, which will result in a $25 No Show Fee, this No-Show Fee will be
    ...
    <ul>
      ...
      :<li>Anyone with a nail condition we suspect may be contagious</li>
      <li>Anyone with open or infected wounds on the treatment area</li>
      <li>
        Anyone in ill health that we may suspect may be contagious, or we fear
        could be harmed by our service
      </li>
      <li>Anyone more than 10-15 minutes late for an appointment</li>
      <li>
        Anyone demonstrating inappropriate behavior to our nail technicians and
        other customers
      </li>
    </ul>
  </p>
